...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>{{trans('app.doctor')}} Management</h2>
            <ol class="breadcrumb">
                <li><a href="{{url('/dashboard')}}">{{trans('app.admin_home')}}</a></li>
                <li class="active">{{trans('app.doctor')}} Listing</li>
            </ol>
        </div>
                                ...
                                <div class="panel-body">
                                    <table id="dataTable"
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <select name="filterSelect[specialization]" id="specialization" style="width: 80px;">
