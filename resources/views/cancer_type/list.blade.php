...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>{{trans('app.cancer_type')}} Management</h2>
            <ol class="breadcrumb">
                <li><a href="{{url('/dashboard')}}">{{trans('app.admin_home')}}</a></li>
                <li class="active">{{trans('app.cancer_type')}} Listing</li>
            </ol>
        </div>
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="activity-but activity-space pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('/cancer_type/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.cancer_type')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-default panel-table">
                                <div class="panel-body">
                                    <table id="dataTable"
                                        ...
                                        <tr>
                                            <th>
                                                <input type="text" name="filter[type]" style="width: 80px;" id="type" value="" />
                                            </th>                                            
                                            <th></th>
                                        </tr>
                                        </thead>
...
<script src="{{url('js/modules/cancer_type.js')}}"></script>
@endpush
@push('internalJsLoad')
<script>
    app.cancer_type.init();
</script>
@endpush