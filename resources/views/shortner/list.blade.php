...
@section('pageTitle')
    {{__('app.default_list_title',["app_name" => __('app.app_name'),"module"=> __('app.shortner')])}}
@endsection
...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>{{trans('app.shortner')}} Management</h2>
            <ol class="breadcrumb">
                <li><a href="{{url('/dashboard')}}">{{trans('app.admin_home')}}</a></li>
                <li class="active">{{trans('app.shortner')}} Listing</li>
            </ol>
        </div>
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="activity-but activity-space pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('/shortner/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.shortner')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-default panel-table">
                                <div class="panel-body">
                                    <table id="dataTable"
                                        ...
                                        <tr>
                                            <th>
                                                <input type="text" name="filter[url]" style="width: 80px;" id="url" value="" />
                                            </th>                                            
                                            <th></th>
                                        </tr>
                                        </thead>
